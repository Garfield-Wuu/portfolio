...
export const news: News[] = [
  ...
  },
  {
    ...
    "date": "_2026-08-1",
    "summary": "> ⚠️ 本期数据受限说明：arXiv论文检索受周末发布节奏影响返回空数据，GitHub Trending页面解析失败，部分web_search连接中断。本期简讯聚焦成功采集的低空经济、人形机器人、大模型三大板块。 --- 29~36°C 多云转阴 | 空气质量：优（AQI 43） | 西北风2级，相对湿度56%",
    "published_at": "_2026-08-1",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
  ...
  },
  {
    ...
    "date": "_2026-08-0",
    "summary": "> 📄 完整 PDF 版本：`reports/daily_briefing/briefing_2026-08-08.pdf` 雨，27℃～32℃，西南风 <3级 - 智元机器人量产突破10000台，领先特斯拉Optimus — [36氪](https://www.36kr.com/p/3740987466399753)",
    "published_at": "_2026-08-0",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
