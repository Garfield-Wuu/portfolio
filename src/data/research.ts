...
// Last updated: 2026-05-05T08:50:41
...
export const newsItems: NewsItem[] = [
  ...
  link: "https://github.com/NVlabs/vla-perf",
...
export const researchTrends: Trend[] = [
  ...
  icon: "🤖",
  title: "VLA训练框架工业化",
  description: "LoongForge (Baidu, ★152) 标志VLA从研究走向工业级训练"
},
  {
  icon: "📡",
  title: "动作空间解耦",
  description: "DAM-VLA的臂/夹爪解耦思想可推广到UAV多动作流"
},
  {
  icon: "📡",
  title: "UAV认知基准建立",
  description: "CognitiveDrone首次建立UAV VLA认知评估体系"
},
  {
  icon: "🤖",
  title: "时间感知VLA兴起",
  description: "PerceiverVLA引入时间维度解决静态VLA局限"
},
  {
  icon: "🤖",
  title: "UAV+VLA研究加速",
  description: "UAV-Track_VLA出现表明更多团队进入UAV VLA领域"
},
];
...
export const publishStats = {
  ...
  githubCount: 8,
  newsCount: 5,
  exportedAt: "2026-05-05T08:49:33.881997"
};
