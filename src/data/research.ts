...
export const news: News[] = [
  ...
  },
  {
    ...
    "date": "_2026-09-0",
    "summary": "> 📄 完整 PDF 版本：`reports/daily_briefing/briefing_2026-09-04.pdf`（4 页） 珠海 阴　当前 26.6℃　今日 24.6–30.2℃　湿度 71%　风速 10.1 km/h 李飞飞 World Labs 的 Atlas 打通「真实照片→3D 空间→机器人传感器视图→可变仿真」；TrAct 用视觉轨迹当世界模型与动作之间的翻译层，LIBERO",
    "published_at": "_2026-09-0",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
  ...
  },
  {
    ...
    "date": "_2026-09-0",
    "summary": "> 完整 PDF：`reports/daily_briefing/briefing_2026-09-03.pdf`（4 页 / 573 KB） 珠海 阴 · 当前 25.1℃ · 今日 24.1–31.4℃ · 湿度 73% · 风速 17.7 km/h 算力厂商向上收编模型分发层",
    "published_at": "_2026-09-0",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
  ...
  {
    "title": "VLA 的竞争焦点从「能不能做」转向「失败了怎么办」",
    "source": "网络",
    "url": "https://www.xiaopeng.com/news/company_news/5585.html",
    "date": "_2026-08-2",
    "summary": "> 📄 完整 PDF 版本：`reports/daily_briefing/briefing_2026-08-29.pdf` 珠海 雷阵雨，当前 29.3℃，全天 26.0–31.8℃，湿度 86%，风速 2.8 km/h 1. VLA 的竞争焦点从「能不能做」转向「失败了怎么办」 — FLARE / TrapVLA / LM-X 同日同题材，成功率与可恢复性取代 demo 泛化性成为核心",
  ...
  {
    "title": "VLA 架构进入「补几何」阶段",
    "source": "网络",
    "url": "https://xix.ai/zh/ainews/zhiyuan-launches-go2-embodied-large-model-setting-new-robot-performance-benchmark.html",
    "date": "_2026-08-2",
    "summary": "> 📄 完整 PDF：`reports/daily_briefing/briefing_2026-08-28.pdf`（5 页） 珠海 雷阵雨，当前 27.9℃（今日 25.9–32.9℃），湿度 91%，风速 4.3 km/h，降水概率 100%。闷热多雷雨，外出带伞。 VLA 架构进入「补几何」阶段",
    "published_at": "_2026-08-2",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
