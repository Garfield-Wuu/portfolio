// Auto-generated at 2026-09-08T08:52:36.206539
...
export const news: News[] = [
  {
    ...
    "date": "2026-09-08",
    "summary": "宇树 UnifoLM-X2-1.0 实现全球首次人形机器人全自主搏击（09-07）。本周宇树 UnifoLM-X2-1.0、智象 HiDream-O1-Embodied、GigaAI GigaBrain-0.7、清华 AIR 自进化 WAM 密集落地，世界模型的焦点从「预测未来帧」转向「用预测干预世界」。",
  ...
  },
  {
    ...
    "date": "2026-09-07",
    "summary": "东方财富报道：宇树上市后市值缩水近半，优必选仍处亏损状态，人形机器人厂商的盈利账依然难算。资本市场对人形机器人的定价开始与实际盈利能力挂钩，出货规模领先不等于利润兑现。",
  ...
  },
  {
    ...
    "date": "2026-08-29",
    "summary": "小鹏汽车官网公布机器人业务首轮融资超 9 亿美元。资本把估值锚打在「量产执行」而非「技术叙事」——小鹏 9 亿美元、宇树 609.93 亿市值、智元 44% 份额登顶、Optimus 数百台零部件实单同期出现。",
...
export const stats = {
  ...
  githubCount: 16,
  newsCount: 7,
  exportTime: "2026-09-08T08:45:32.838665",
};
