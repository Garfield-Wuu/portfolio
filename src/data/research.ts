// Auto-generated at 2026-09-03T00:07:48.088977
...
export const news: News[] = [
  {
    ...
    "date": "2026-08-29",
    "summary": "资本把估值锚打在「量产执行」而非「技术叙事」：小鹏机器人业务首轮融资超 9 亿美元，同期宇树 609.93 亿市值、智元以 44% 份额登顶出货榜、Optimus 拿到数百台零部件实单。",
  ...
  },
  {
    ...
    "date": "2026-08-28",
    "summary": "GO-2 主打通用操作能力，在机器人性能基准上刷新纪录。国内具身基座模型的迭代节奏已压到季度级，基座竞争从参数规模转向真实任务成功率。",
  ...
  },
  {
    ...
    "date": "2026-08-24",
    "summary": "MoE 架构分「推理器」（因果自注意力，理解）与「生成器」（双向注意力，跨模态生成），支持动力学/逆动力学/策略三种训练模式。预训练折合约 1000 万小时视频，可通过逆动力学从多视角视频反推动作，挖掘海量无标注数据。",
  ...
  },
  {
    ...
    "date": "2026-08-23",
    "summary": "宇树科技上市、Optimus 量产与世界机器人大会同期落地，人形机器人进入产业化竞速。中国拿下全球 97% 出货量，智元与宇树合计约 75%，护城河从技术参数转向供应链工艺产能弹性。",
...
export const stats = {
  ...
  githubCount: 16,
  newsCount: 6,
  exportTime: "2026-09-03T00:00:51.277697",
};
