// Auto-generated at 2026-09-09T08:52:59.522893
...
export const news: News[] = [
  {
    ...
    "date": "2026-09-08",
    "summary": "NYU 数学教授 Tristan Buckmaster 与 Anthropic 数学家 Levent Alpöge 公布针对 Navier-Stokes 存在与光滑性千禧年难题的三项独立证明初步结果后，指控 OpenAI 不正当竞争、研究进展信息被不当获取，Bubeck 否认。同行评议确认前不宜当既成事实引用。",
  ...
  },
  {
    ...
    "date": "2026-09-08",
    "summary": "宇树发布 UnifoLM-X2-1.0 并实现全球首次人形机器人全自主搏击。该方案属于本周密集落地的具身世界模型之一（另有智象 HiDream-O1-Embodied、GigaAI GigaBrain-0.7、清华 AIR 自进化 WAM），焦点从「预测未来帧」转向「用预测干预世界」。",
    "published_at": "2026-09-08",
    "verified": false,
    "why_it_matters": null,
    "research_axis": "Robotics",
  ...
  {
    "title": "人形机器人从「能动」转向「能算账」：97% 中国造，智元和宇树吃掉 75%",
    "source": "澎湃新闻",
  ...
  },
  {
    ...
    "date": "2026-09-03",
    "summary": "宇树上市后市值较峰值回落近半，优必选上半年仍亏损 3.39 亿元，人形机器人厂商的盈利账难算。估值逻辑正从运动能力炫技切换到量产交付与毛利，竞争焦点被重新定义为「拼大脑、拼体系化能力」。",
...
export const stats = {
  ...
  githubCount: 16,
  newsCount: 7,
  exportTime: "2026-09-09T08:46:03.008599",
};
